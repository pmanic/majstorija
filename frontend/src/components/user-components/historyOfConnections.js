...
import { getAllArchivedUserZahtevi } from "../../redux/actions/zahtevActions";
import { getRepairmanProfiles } from "../../redux/actions/profileActions";

class DeclinedReq extends Component {
    componentDidMount() {
        this.props.getAllArchivedUserZahtevi();
    ...
    render() {
        ...
        return (
            <div style={{ margin: 'auto', width: '100%' }}>
                <div className="naslov"><h1>Istorija zahteva</h1></div>
                <div
                    style={{
                        display: 'flex',
                        alignItems: 'center',
...
DeclinedReq.propTypes = {
    getAllArchivedUserZahtevi: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getRepairmanProfiles, getAllArchivedUserZahtevi })(DeclinedReq);
