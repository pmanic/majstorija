...
class SentReq extends Component {
    ...
    render() {
        ...
        if (zahtevi === null || profiles === null || loading || this.props.profile.loading || this.props.profile === null) {
            ...
            listOfReq = <h1 style={{ color: 'rgb(31,41,68)' }}>Trenutno nema prihvaćenih zahteva...</h1>
        }

        return (
            <div style={{ margin: 'auto', width: '100%' }}>
                <div className="naslov"><h1>Prihaćeni zahtevi</h1></div>
                <div
                    style={{
                        display: 'flex',
                        alignItems: 'center',
...
export default connect(mapStateToProps, { getAllAcceptedRepairmanZahtevi, getUserProfiles })(SentReq);
