...
import { getAllRepairmanZahtevi } from "../../../redux/actions/zahtevActions";
import { getUserProfiles } from "../../../redux/actions/profileActions";

class SentReq extends Component {
    componentDidMount() {
        this.props.getAllRepairmanZahtevi();
    ...
    render() {
        ...
        if (zahtevi === null || profiles === null || loading || this.props.profile.loading || this.props.profile === null) {
            ...
            listOfReq = <h1 style={{ color: 'rgb(31,41,68)' }}>Trenutno nema novih zahteva...</h1>
        }
...
SentReq.propTypes = {
    getAllRepairmanZahtevi: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getAllRepairmanZahtevi, getUserProfiles })(SentReq);
